class Tosa < Formula
  ...
  if Hardware::CPU.is_64_bit?
    url "https://github.com/kyoshidajp/tosa/releases/download/v0.0.1/ghkw_darwin_amd64.zip"
    sha256 "2512467d86085d24119c273b42e67bdcb3899690439474f0060027108aee2c61"
  else
    url "https://github.com/kyoshidajp/tosa/releases/download/v0.0.1/ghkw_darwin_386.zip"
